...
export function ContactModal({
  ...
  // Update default topic when it changes
  useEffect(() => {
    if (defaultTopic) {
            ...
            <div className="animate-fadeIn">
              <div className="mb-6">
                <h2 className="mb-2 font-mono text-lg font-medium text-zinc-100">
                  <span className="text-emerald-500">$</span> schedule --meeting
                </h2>
                <p className="text-sm text-zinc-400">
                  Great! Now pick a time that works for you.
                </p>
              </div>

              {/* Calendar embed placeholder */}
              <div className="mb-4 overflow-hidden rounded border border-zinc-700 bg-zinc-800/30">
                <div className="border-b border-zinc-700 bg-zinc-800/50 px-4 py-2">
                  <span className="font-mono text-xs text-zinc-400">
                    {calendarConfig.provider === 'calendly' ? 'Calendly' : 'Google Calendar'}
                  </span>
                </div>
                <div className="flex min-h-[280px] flex-col items-center justify-center p-6">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full border border-lime-500/30 bg-lime-500/10">
                    <svg
                  ...
                  <p className="mb-3 text-center text-sm text-zinc-400">
                    Calendar widget would embed here
                  </p>
                  <p className="mb-4 font-mono text-xs text-zinc-600">
                    {calendarConfig.embedUrl}
                  </p>
                  <button
                    type="button"
                    onClick={handleBookingComplete}
                    className="rounded border border-lime-500/50 bg-lime-500/10 px-4 py-2 font-mono text-xs text-lime-400 transition-all hover:bg-lime-500/20"
                  >
          ...
          {step === 'success' && (
            <div className="animate-fadeIn flex min-h-[300px] flex-col items-center justify-center text-center">
              ...
              <p className="mb-6 max-w-xs text-sm text-zinc-400">
                You&apos;re all set! I&apos;ll send a confirmation email shortly. Looking
                forward to our conversation.
              </p>
              <div className="space-y-2 font-mono text-xs text-zinc-500">
                <p>
                  <span className="text-zinc-600">&gt;</span> Meeting scheduled{' '}
                ...
                <p>
                  <span className="text-zinc-600">&gt;</span> Confirmation email queued{' '}
                  <span className="text-lime-500">✓</span>
                </p>
              </div>
              <button
