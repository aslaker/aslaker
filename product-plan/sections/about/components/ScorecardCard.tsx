    ...
    <tr className="group/row border-b border-zinc-800/50 transition-colors hover:bg-zinc-900/50">
      <td className="py-4 pl-4 pr-4">
        <div className="flex items-center gap-2">
          {isTopRated && (
            <svg className="h-3.5 w-3.5 shrink-0 text-amber-400" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
...
export function ScorecardCard({
  ...
  // Sort games by rating (highest first), then by play count
