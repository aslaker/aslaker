    ...
    return (
      <div className="rounded border border-dashed border-zinc-700 bg-zinc-900/20 px-4 py-3">
        <div className="flex items-center gap-2">
          <svg className="h-4 w-4 text-zinc-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  return (
    <div className="rounded border border-zinc-800 bg-zinc-900/30">
      <div className="flex items-center gap-2 border-b border-zinc-800 px-4 py-2.5">
        <svg className="h-4 w-4 text-lime-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
        </svg>
...
export function TrailMapCard({
  ...
  // Separate explored and unexplored areas
  ...
  return (
    ...
    >
      ...
      {/* Topographic-style pattern overlay - very subtle */}
      ...
      {/* Header with mountain icon and stats */}
      ...
      {/* Coaching credentials - badge style */}
