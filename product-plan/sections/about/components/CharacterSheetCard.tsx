...
function StatBar({ trait }: { trait: Trait }) {
  // D&D stats typically range 3-20, normalize to percentage
...
export function CharacterSheetCard({
  ...
  // Split traits into two columns for better use of horizontal space
  ...
  return (
    ...
    >
      ...
      {/* Terminal header - Character sheet style */}
      ...
      {/* Character header with D20 icon */}
      ...
      {/* Stat block - two column layout on larger screens */}
      ...
      {/* Flavor text - like a character sheet tagline */}
      {interest.flavorText && (
