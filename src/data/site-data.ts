...
export const projects: Project[] = [
	...
	},
	{
		...
		title: "Aperant",
		shortDescription:
			"An autonomous AI coding platform that helps teams plan, build, test, and ship software through a multi-agent workflow.",
		fullDescription:
			"Aperant is an autonomous AI coding platform focused on turning software goals into shipped work through a coordinated multi-agent pipeline.\n\nI am building the cloud version as CTO and Co-Founder, while the open source project provides a public foundation for the product's core ideas around planning, execution, validation, and safe parallel workflows.",
		logoUrl: "",
		...
		screenshots: [],
		githubUrl: "https://github.com/AndyMik90/Aperant",
		demoUrl: "https://aperant.com",
		phase: "building",
	},
	{
		id: "tasterra",
		title: "Tasterra",
		shortDescription:
			"Professional sensory management software for craft beverage producers to run taste panels, capture feedback, and improve product consistency.",
		fullDescription:
			"Tasterra brings lab-quality sensory analysis workflows to craft beverage producers through structured panel management, collaborative tasting sessions, and centralized quality data.\n\nThe platform is built to help teams document evaluations, spot trends over time, and maintain consistency across batches and locations without relying on scattered spreadsheets or manual notes.",
		logoUrl: "/projects/tasterra/logo.png",
		tags: ["B2B SaaS", "AI/ML", "Full-Stack"],
		technologies: ["Next.js", "Convex", "Clerk", "OpenAI", "Vercel"],
		screenshots: [],
		githubUrl: null,
		demoUrl: "https://tasterra.app",
		phase: "deployed",
	},
	{
		id: "spanreedr",
		title: "Spanreedr",
		shortDescription:
			"An AI-enabled newsletter platform that helps solo founders turn their ideas into consistent thought leadership and brand-building content.",
		fullDescription:
			"Spanreedr is an AI-enabled newsletter product designed for solo founders who want to publish consistently without losing their own voice.\n\nIt focuses on helping founders develop ideas, shape their point of view, and turn raw thoughts into newsletter-ready content that strengthens their brand over time.",
		logoUrl: "",
		tags: ["AI/ML", "Creator Tools", "B2B SaaS"],
		technologies: ["Next.js", "Convex", "Vercel AI", "Exa AI", "Supadata"],
		screenshots: [],
		githubUrl: null,
		demoUrl: null,
		phase: "building",
